...
# While we run this feature file we get some "ClassNotFoundexception", we miss plugin's
# that's y the error we coming. to overcome this we go for next session
