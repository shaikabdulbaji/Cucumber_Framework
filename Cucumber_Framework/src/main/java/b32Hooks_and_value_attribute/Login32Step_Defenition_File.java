...
public class Login32Step_Defenition_File {
	
	@Before(order = 0, value="@register")
	public void setup()
	{
		System.out.println("$$ SetUp  Before Hook Method got Executed $$");
	}
	
	@After(order = 1, value="@register")
	public void teardown()
	{
		System.out.println("$$ TearDown  After Hook Method got Executed $$");
	}
