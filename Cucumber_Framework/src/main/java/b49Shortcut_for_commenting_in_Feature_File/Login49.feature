#In case of writing "@all" on each and every scenario we directly place "@all" above
#the feature it will applicable to each and every scenario.


#If we want to comment one line select that one line and click on "#".
#If we want to comment one line (or) paragraph select that one line (or) paragraph and click on "ctr+/".
