...
@CucumberOptions(
		features="src/main/java/b51Integrating_TestNG_in_Cucumber_features",
		glue={"b51Integrating_TestNG_in_Cucumber_Stepdefinition","b51Integrating_TestNG_in_Cucumber_MyHooks"},
		tags="@all",
		plugin= {"pretty",
