package b12Creating_Step_Definitions_and_Running_Feature_Files;
...
public class Login12Step_Defenition_File {
	...
	public void user_enters_valid_email_address(String validemailAddressText) {
		
	    System.out.println(">> User enters valid email address :"+ validemailAddressText);
		
	}

	@When("Enter valid password {string}")
	public void enter_valid_password(String validpasswordText) {
		
	    System.out.println(">> User enters valid password text :"+ validpasswordText);
