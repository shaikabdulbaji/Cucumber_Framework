...
public class Login30Step_Defenition_File {
	
	
	/*
	// The both steps will execute for each and every step 
	@BeforeStep
	public void beforeEveryStep()
	{
		System.out.println("++ Execute Before Every Step Hook");
	}
	
	@AfterStep
	public void afterEveryStep()
	{
		System.out.println("++ Execute After Every Step Hook");
	}
	*/
	
	// The both steps will execute for each and every step of "@register" tag
	@BeforeStep("@register")
	public void beforeEveryStep()
	{
		System.out.println("++ Execute Before Every Step Hook");
