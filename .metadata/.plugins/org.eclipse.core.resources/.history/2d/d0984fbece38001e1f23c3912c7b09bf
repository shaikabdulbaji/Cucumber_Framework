package b15Running_Multiple_Feature_Files_together_using_Runner_Class;

import io.cucumber.java.en.*;

public class Register13Step_Defenition_File {
	...
	@When("User enter last name {string} into the Last Name Field")
	...
	@When("User enter email address {string} into the Email Address Field")
	...
	@When("User enter telephone {string} into the Telephone Field")
	...
	@When("User enter password {string} into the Password Field")
	...
	@When("User enter password {string} into the Confirm Password Field")
